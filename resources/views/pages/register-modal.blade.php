        ...
        <div class="modal-content p-4 p-lg-5 rounded-4 shadow-sm border-0">
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="row g-3">
                    ...
                    <!-- E-posta -->
                    <div class="col-md-6">
                        <input type="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" placeholder="E-posta" value="{{ old('email') }}" required>
                ...
                <div class="form-check mt-4">
                    ...
                    <label class="form-check-label" for="agreement">
                        <a href="/bireysel-uyelik-sozlesmesi" target="_blank" class="text-decoration-underline text-dark">
                            Üyelik Sözleşmesi
